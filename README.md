...
In order to be able to connect to the Twitter API and extract the populated Tweets in each data collection span, first it is necessary to create a Twitter application:
